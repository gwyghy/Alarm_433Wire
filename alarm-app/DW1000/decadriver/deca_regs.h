...
/* All RX errors mask. expect SYS_STATUS_AFFREJ */															
#define SYS_STATUS_ALL_RX_ERR  (SYS_STATUS_RXPHE | SYS_STATUS_RXFCE | SYS_STATUS_RXRFSL | SYS_STATUS_RXSFDTO \
                                | SYS_STATUS_LDEERR | SYS_STATUS_RXRFTO | SYS_STATUS_RXPTO)

#define SYS_STATUS_ALL_RX_ERR_CLE  (SYS_STATUS_RXPHE | SYS_STATUS_RXFCE | SYS_STATUS_RXRFSL | SYS_STATUS_RXSFDTO \
