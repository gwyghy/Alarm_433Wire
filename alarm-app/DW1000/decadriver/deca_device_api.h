...
#define DWT_INT_ALL             DWT_INT_RPHE | \
								DWT_INT_RPHE | \
								DWT_INT_RFCG | \
								DWT_INT_RFCE | \
								DWT_INT_RFSL | \
...
#define DWT_INT_ALL_CLE         DWT_INT_ARFE | \
								DWT_INT_RPHE | \
								DWT_INT_RFCG | \
								DWT_INT_RFCE | \
								DWT_INT_RFSL | \
...
typedef void (*dwt_cb_t)(const dwt_cb_data_s *);

/*! ------------------------------------------------------------------------------------------------------------------
 * Structure typedef: DWT_Config_s
 *
...
typedef struct
{
    ...
    dwt_cb_data_s cbData;           // Callback data structure
 ...
 *    application level.
 *  - DWT_SetXtalTrim: Renamed to dwt_setxtaltrim.
 ...
 * no return value
 */
void DWT_Configure(DWT_Config_s *config) ;
