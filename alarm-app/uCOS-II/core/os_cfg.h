...
#define OS_LOWEST_PRIO           40u    /* Defines the lowest priority that can be assigned ...         */
                                        /* ... MUST NEVER be higher than 254!                           */

#define OS_MAX_EVENTS            20u	//10u    /* Max. number of event control blocks in your application      */
...
#define OS_MAX_TASKS             30u    //20u /* Max. number of tasks in your application, MUST be >= 2       */
...
#define OS_TASK_QUERY_EN          1u    //2013-3-18 Ìï¶«Éý/*     Include code for OSTaskQuery()                           */
...
#define OS_TASK_SUSPEND_EN        1u    //2013-3-18 Ìï¶«Éý/*     Include code for OSTaskSuspend() and OSTaskResume()      */
...
#define OS_MUTEX_EN               1u    //2013.1.14 Ìï¶«Éý /* Enable (1) or Disable (0) code generation for MUTEX          */
...
#define OS_MUTEX_QUERY_EN         1u    /*     Include code for OSMutexQuery()                          */
                                        ...
                                        /* ---------------------- MESSAGE QUEUES ---------------------- */
#ifdef USE_WIFI						    //2013.3.21 Ìï¶«Éý 
...
#define OS_TMR_CFG_NAME_EN        1u    /*     Determine timer name                                     */
